...
describe AssetsController do
  ...
  let(:valid_attributes) { { name: 'Poupança', type: 'AssetTypes::Saving', ticker: '' } }
  ...
  describe "GET index" do
    it "lists all assets" do
      asset1 = FactoryGirl.create(:asset, name: 'Poupança_1')
      asset2 = FactoryGirl.create(:asset, name: 'Poupança_2')
  ...
  #       post :create, {:asset => { invalid: "invalid" }}, valid_session
  #       assigns(:asset).should be_a_new(Asset)
  #     end
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Asset.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => asset.to_param, :asset => { invalid: "invalid" }}, valid_session
  #       assigns(:asset).should eq(asset)
  #     end
